                    ...
                    Container(
                        ...
                        child: ListView(
                            ...
                            children: [
                              buildIngredientItem(
                                  'Water',
                                  Icon(Feather.droplet,size: 10.0, color: Colors.white),
                                  Color(0xFF6FC5DA)),
                              buildIngredientItem(
                                'Brewed Espresso',
                              ...
                              buildIngredientItem(
                                'Sugar',
                                Icon(Feather.box,size: 18.0,color: Colors.white,),Color(0xFFF39595)),
                              buildIngredientItem(
                                'Toffee Nut Syrup',
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: InkWell(
                              ...
                              onTap: (){ Navigator.of(context).pushReplacementNamed(Order.routeName);}
                            ),
                          ),
                        )
                      ),
